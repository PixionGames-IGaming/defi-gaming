...
const Support = () => {
  ...
  return (
    <>
      <Helmet>
        <title>MarketHub | Support</title>
        <meta name="description" content="MarketHub marketplace support" />
      </Helmet>
          ...
          <div className="row d-flex justify-content-center pt-4">
            <div className="col-11 col-md-10 col-lg-8 text-center pricingSection">
              ...
              <span className="FontTow d-block mt-2 mx-lg-5">
                MarketHub offers competitive license rates and listing plans to help
                you match model demand and budget.
              </span>
            </div>
          </div>
          <div className="row d-flex justify-content-center my-4">
                ...
                <div className="faq-item" onClick={HandelIconDropDownMenu}>
                  <details>
                    <summary className="d-flex justify-content-between align-items-center">
                      What is a custom model listing?
                      <span className="icon">
                        <FaAngleDown />
                      </span>
                    </summary>
                    <p>
                      A listing is a verified custom AI model that can move through the market desk,
                      collect listing fees, and settle inference royalties through MarketHub.
                      Crypto checkout is a further feature.
                    </p>
                  </details>
                </div>
              </div>
