...
const Trending = ({ Data }) => {
  ...
  return (
    <>
      <Helmet>
        <title>MarketHub | Builder Rankings</title>
        <meta name="description" content="MarketHub builder rankings" />
      </Helmet>
      <section id="rankings">
          ...
          <div className="row mx-2 pageTitle mb-5">
            <div className="col-12">
              <span className="d-block F1 textS1">
                <span className="lemon">Builder</span> Rankings
              </span>
              <span className="d-block F3 textS2">
                Rank the highest-performing builders by license volume on MarketHub.
              </span>
            </div>
          </div>
