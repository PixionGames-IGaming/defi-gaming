...
const AICreateNFT = ({ Data }) => {
  ...
  const downloadImage = () => {
    ...
    a.href = imageUrl;
    a.download = "markethub-model-card.png";
    a.click();
  };
  ...
  return (
    <>
      <Helmet>
        <title>MarketHub | Model Card</title>
        <meta name="description" content="Generate a custom model card from a prompt" />
      </Helmet>
          ...
          <div className="row pageTitle mb-4">
            <div className="col-12">
              <span className="d-block F1 textS1">
                <span className="lemon">Model</span> Card
              </span>
              <span className="d-block F3 textS2">Describe the model and generate a marketplace card</span>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-12 col-md-6">
              ...
              <textarea
                ...
                placeholder="e.g. A language model card with circuit traces, dark studio light, HUB badge"
              />
              ...
              <div className="mt-4">
                {error ? (
                  ...
                  <small className="text-muted">Generate a lot label preview from your prompt.</small>
                )}
              </div>
            </div>
