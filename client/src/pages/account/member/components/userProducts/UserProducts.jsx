            ...
            {vuierState === "NFTs" ? (
              <>
                {rowData?.NFTsMarket?.NFTs?.filter((nftItem) =>
                  userInfromation?.NFTs?.includes(nftItem.id)
                ).map((item, index) => (
                  <div key={index} className="col-12 col-md-6 col-lg-4 pt-4">
                    <div to={`/model/${item.postTitle}`} className="card">
                      <Link to={`/model/${item.postTitle}`} className="CrdTools">
                        <img
                          src={item.postImg}
              ...
              <>
                {rowData?.NFTsMarket?.Collections?.filter((collectionItem) =>
                  userInfromation?.collection?.includes(collectionItem.id)
                ).map((item, index) => (
                  <div key={index} className="col-12 col-md-6 col-lg-4 pt-4">
