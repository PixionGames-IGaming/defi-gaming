        ...
        <div className="row mx-0">
          <div className="col-12">
            <span className="F1 textS1 d-block">
              <span className="lemon">Model</span> Catalog
            </span>
            <span className="F4 textS2 d-flex mt-1">
              Browse more than 50k custom models across language, vision, audio, and multimodal catalogs.
            </span>
            <div className="d-flex align-items-center gap-1 mt-4">
              <div className="searchComponant d-flex justify-content-between align-items-center px-3 w-100">
                <input
                  type="text"
                  placeholder="Search models, builders, or collections"
          ...
          <div className="col-12 d-flex align-items-center mt-3">
            ...
            >
              <div className="item py-2">
                <span className="F4">Type</span>
              </div>
              <div className="item py-2">
                <span className="F4">Price</span>
              </div>
              <div className="item py-2">
                <span className="F4">license</span>
              </div>
              <div className="item py-2">
                <span className="F4">builder</span>
              </div>
              <div className="item py-2">
                <span className="F4">task</span>
              </div>
              <div className="item py-2">
                <span className="F4">suite</span>
              </div>
            </div>
          </div>
        </div>
