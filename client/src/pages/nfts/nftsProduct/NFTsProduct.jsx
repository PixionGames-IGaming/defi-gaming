...
const NFTs = ({
  ...
  }, [NfsData.FilterItems, NfsData.NFTs]);
      ...
      <div className="container pb-2 pt-3">
                            ...
                            <div className="card-meta d-flex justify-content-between align-items-center mt-3 gap-3">
                              ...
                              >
                                ...
                                <div>
                                  ...
                                  <span className="F5 userLabel">Builder</span>
                                </div>
                              </Link>
                              <div className="priceBadge text-end">
                                <span className="F5">License</span>
                                <span className="F3">1 of 1</span>
                              </div>
                            </div>
                            <div className="d-flex justify-content-between align-items-center mt-3 prodictInfo">
                              <div>
                                <span className="F4 d-block">License Price</span>
                                <span className="F3">{item.postPrice} HUB</span>
                              </div>
                              <div className="text-end">
                                <span className="F4 d-block">Top Offer</span>
                                <span className="F3">
                                  {item.postHightesBid} HUB
                                </span>
                              </div>
                            </div>
                          </div>
        ...
        {!loading && visibleCount >= activeList.length && activeList.length > 0 && (
          <div className="nftEndMessage">
            You've seen all {activeList.length} lots
          </div>
        )}
      </div>
    </section>
