const EarningsOverview = ({ data }) => {
  const defaultEarnings = {
    rows: [
      { label: "Listing Fees", value: "$ 1,250.00" },
      { label: "Stake Yield", value: "$ 890.00" },
      { label: "Inference Royalties", value: "$ 2,295.00" },
    ],
    claimable: "$ 5,435.00",
    monthlyGrowth: "+12.8%",
    ...
    payoutLegend: [
      ...
      { color: "var(--sg-purple-soft)", label: "License" },
  ...
  return (
    <section className="soft-section">
      <div className="container">
        <h2 className="soft-section-title">Builder Yield</h2>
        <p className="soft-section-sub mb-4">
          Track listing fees, stake yield, and inference royalties in one ledger.
        </p>
        <div className="sg-earnings-grid">
          ...
          <div className="sg-earnings-card sg-donut-wrap">
            ...
            <div>
              ...
              <p className="sg-donut-note mb-0">
                Active and payout channels currently account for most inflow. Share yield accelerated this cycle.
              </p>
            </div>
          </div>
          ...
          <div className="sg-earnings-card sg-earnings-wide">
            ...
            <p className="soft-section-sub mb-3">
              Estimated earnings trajectory based on reserved stake and license demand.
            </p>
